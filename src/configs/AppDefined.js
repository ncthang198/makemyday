...
export const CODE_FAILED = [BAD_REQUEST, UNAUTHORIZED, INTERNAL_SERVER, NOT_FOUND]
...
export const HEIGHT_STATUS_BAR = Platform.OS === 'ios' ? 20 : StatusBar.currentHeight;
...
export const COORDINATES_VNPOST = { latitude: COORDINATES_DEFAULT[1], longitude: COORDINATES_DEFAULT[0] };
